...
if (!defined('G5_SET_TIME_LIMIT')) define('G5_SET_TIME_LIMIT', 30);
@set_time_limit(G5_SET_TIME_LIMIT);
//for debugging .bylee (* 정상 운영시 0 셋팅)
...
//    G5_ORACLE_HOST,G5_ORACLE_PORT,G5_ORACLE_SID);
//    $connect_db = oci_connect(G5_ORACLE_USER,G5_ORACLE_PASSWORD,$connStr,G5_ORACLE_CHARSET);

    $connect_db = sql_connect(G5_ORACLE_HOST,G5_ORACLE_USER,G5_ORACLE_PASSWORD);
    if(!$connect_db)
        exit();
...
ini_set("session.cache_expire", 180); // 세션 캐쉬 보관시간 (분) default 180 분  >  15일 유지  ^ _____^
ini_set("session.gc_maxlifetime", 86400); // session data의 garbage collection 존재 기간을 지정 (초) > default 10800 초(3시간) > 86400 sec (24시간 유지)
// 어플 닫기 > 백그라운드에 그대로 로딩되어져 있음 -> 24시간 (86400 sec) -> 4일로 업뎃 (345600)  -> 12일 (1036800)
...
//bylee
$config['cf_theme'] = "munhwa"; // theme munhwa  사용 설정
$config['cf_site_name']="카포 PDA";
$config['cf_title']="카포 PDA";
$config['cf_admin']="yourday";
$config['cf_admin_email']="xapps.kr@gmail.com";
$config['cf_admin_email_name']="운영자";
$config['cf_add_script']="";
$config['cf_use_point']=0;
$config['cf_point_term']=0;
$config['cf_use_copy_log']=0;
$config['cf_use_email_certify']=0;
$config['cf_login_point']=0;
$config['cf_cut_name']=15;
$config['cf_nick_modify']=30;
$config['cf_new_skin']="theme/basic";
$config['cf_new_rows']=15;
$config['cf_search_skin']="theme/basic";
$config['cf_connect_skin']="theme/basic";
$config['cf_faq_skin']="theme/basic";
$config['cf_read_point']=0;
$config['cf_write_point']=0;
$config['cf_comment_point']=0;
$config['cf_download_point']=0;
$config['cf_write_pages']=10;
$config['cf_mobile_pages']=5;
$config['cf_link_target']="_blank";
$config['cf_delay_sec']=20;
$config['cf_filter']="18아,18놈,18새끼,18뇬,18노,18것,18넘,개년,개놈,개뇬,개새,개색끼,개세끼,개세이,개쉐이,개쉑,개쉽,개시키,개자식,개좆,게색기,게색끼,광뇬,뇬";
$config['cf_member_skin']="theme/basic";
$config['cf_use_hp']=1;
$config['cf_register_level']=2;
$config['cf_register_point']=0;
$config['cf_icon_level']=3;
$config['cf_leave_day']=30;
$config['cf_search_part']=10000;
$config['cf_email_use']=1;
$config['cf_email_mb_member']=1;
...
$config['cf_new_del']=30;
$config['cf_memo_del']=180;
$config['cf_visit_del']=180;
$config['cf_popular_del']=180;
$config['cf_member_icon_size']=5000;
$config['cf_member_icon_size']=5000;
$config['cf_member_icon_width']=24;
$config['cf_member_icon_height']=24;
$config['cf_member_img_size']=5000;
$config['cf_member_img_width']=60;
$config['cf_member_img_height']=60;
$config['cf_login_minutes']=10;
$config['cf_image_extension']="gif|jpg|jpeg|png";
$config['cf_formmail_is_member']=1;
$config['cf_page_rows']=15;
$config['cf_mobile_page_rows']=15;
$config['cf_memo_send_point']=0;
$config['cf_mobile_new_skin']="theme/basic";
$config['cf_mobile_search_skin']="theme/basic";
$config['cf_mobile_connect_skin']="theme/basic";
$config['cf_mobile_faq_skin']="theme/basic";
$config['cf_mobile_member_skin']="theme/basic";
$config['cf_member_captcha_mp3']="basic";
$config['cf_editor']="smarteditor2";
$config['cf_captcha']="kcaptcha";
...
if ($_SESSION['ss_mb_id']) { // 로그인중이라면
    ...
    //bylee
//    if(is_mobile() && !get_pure_cookie("app_user_data")){ //is_mobile() &&
...
if ($member['mb_id']) {
    ...
    if ($_SESSION['ss_work_type']){
        //$work_type = $_SESSION['ss_work_type'];
        $DefJgGubun = $_SESSION['ss_work_type'];
    }
...
if(isset($config['cf_theme']) && trim($config['cf_theme'])) {
    ...
    if(is_dir($theme_path)) {
        ...
        define('G5_THEME_SVG_URL',     G5_THEME_URL.'/'.G5_SVG_DIR);
...
////// sessoin check /////////////////////////////////////////////////////////////////////////////////////////////
/*
$logger = initializeMonoLogger("login");
$logger->error("login check", array("called  ==================================================="));

// 자동로그인 부분에서 첫로그인에 포인트 부여하던것을 로그인중일때로 변경하면서 코드도 대폭 수정하였습니다.
if ($_SESSION['ss_mb_id']) { // 로그인중이라면
    $logger->error("login session 11 ", array($_SESSION['ss_mb_id']));
} else {
    ...
    if ($tmp_mb_id = get_cookie('ck_mb_id')) {
        ...
        $logger->error("login cookie 22 ", array($tmp_mb_id));
    }
...
header('Cache-User-Data:'.$_SESSION['ss_mb_id']); //bylee
