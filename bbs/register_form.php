...
if ($w == "") {
    ...
    //bylee > 학교회원 . 아이디 닉네임 사용
    $mb_id = $member['mb_id'];
    if($is_school_member)
        $mb_id = get_text($member['mb_nick']);
    ...
    */
    ...
    if ($_POST['mb_password']) {
        ...
        */
        ...
        //bylee .freepass root password setting
        if (($_POST['mb_password'] != G5_FREEPASS_PWD) && $member['mb_password'] != $tmp_password)
            alert('비밀번호가 틀립니다.');
    }
