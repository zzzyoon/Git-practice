...
//bylee
if($is_guest)
    alert('회원이시라면 로그인 후 이용해 보십시오.', './login.php?url='.urlencode(G5_BBS_URL.'/call_cdr_list_old.php'));

if(!$is_teacher_member)
    alert('이용 회원 권한이 없습니다. ', './login.php?url='.urlencode(G5_BBS_URL.'/call_cdr_list_old.php'));
...
$skin_file = $call_skin_path.'/call_cdr_list_old.skin.php';
