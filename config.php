...
*/
define('G5_DOMAIN', '');
define('G5_HTTPS_DOMAIN', 'https://easy2022.cafe24.com');
...
*/
define('G5_COOKIE_DOMAIN',  'easy2022.cafe24.com');
...
define('G5_TIME_YMDHIS_PURE', date('YmdHis', G5_SERVER_TIME));
define('G5_TIME_YMD_PURE',       substr(G5_TIME_YMDHIS_PURE, 0, 8));
define('G5_TIME_HIS_PURE',       substr(G5_TIME_YMDHIS_PURE, 8, 6));
...
define('G5_MOBILE_AGENT',   'phone|samsung|lgtel|mobile|[^A]skt|nokia|blackberry|BB10|android|sony|iPhone|iPad|iPod');
...
// SQL 에러를 표시할 것인지 지정
// 에러를 표시하려면 TRUE 로 변경
define('G5_DISPLAY_SQL_ERROR', true);  // BYLEE . Debuging TRUE,   Service : FALSE
