...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <h1 id="bo_v_title">
            <?php
            if ($category_name=="환불완료") echo "<button type='button' class='btn btn-danger' >상태 : {$view['ca_name']}</button> | "; // 분류 출력 끝
            else if ($category_name) echo "<button type='button' class='btn btn-outline-secondary' >상태 : {$view['ca_name']}</button> | "; // 분류 출력 끝
    ...
    <?php if($view['wr_1']) { ?>
    <section class="alert alert-danger p-2 font-weight-bold">
        <div class="row">
            <div class="col-md-3 col-12">
                <button type="button" class="btn btn-sm btn-outline-danger"> 환불 금액  </button>    <?php echo number_format($view['wr_1']) ?>원
            </div>
            <div class="col-md-4 col-12">
               <button type="button" class="btn btn-sm btn-outline-danger"> 환불 일자  </button> <?php echo $view['wr_2']?>
             </div>
        </div>
    </section>
    <?php } ?>
