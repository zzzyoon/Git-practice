...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        ...
        <h4 class="bg-primary rounded-pill text-light d-inline-block py-2 px-3 mt-2">
            대행사 : <?=getAgencyName($view['wr_1'])?>
        </h4>
        ...
        <h1 id="bo_v_title">
            ...
            <?php
            if ($category_name) echo "지역 : ".$view['ca_name'].' | '; // 분류 출력 끝
            echo "<strong>학교명 : ".cut_str(get_text($view['wr_subject']), 70)."</strong>"; // 글제목 출력
            ?>

            &nbsp;

            <span class="bg-secondary text-light rounded-pill px-2 py-1 text-size-4">
            년도 : <?=$view['wr_2']?>
                </span>
        </h1>
    </header>
