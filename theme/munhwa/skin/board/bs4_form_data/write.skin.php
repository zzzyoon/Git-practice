...
//        $wr_year = date("Y",strtotime("+1 year"));
//    else
     $wr_year = date("Y");
} else {
    $wr_year = $write['wr_2'];
...
if($w=="u" && $write['wr_1']){
    ...
    $write['wr_1_nm'] = getAgencyName($write['wr_1']);
}
...
<section id="bo_w">
    ...
    <div class="row">
        ...
        <div class="col-md-6 form-group label-floating">
            <label for="wr_1_nm">대행사</label>
            <div class="input-group">
                <input type="hidden" name="wr_1" id="wr_1" value="<?php echo $write['wr_1'] ?>" >
                <input type="text" name="wr_1_nm" value="<?php echo $write['wr_1_nm'] ?>" id="wr_1_nm"  class="form-control required" required placeholder="대행사를 선택하세요.">
        ...
        <div class="col-md-2">
            <label class="control-label" for="wr_2">년도</label>
            <input type="text" class="form-control text-center font-weight-bold numeric required" required minlength="4"  readonly name="wr_2" id="wr_2" value="<?=$wr_year; ?>">
        </div>
	...
	<div class="form-group label-floating">
	    <label class="control-label" for="wr_subject">학교명</label> <!--제목 -->
	...
	<div class="form-group">
		<div class="input-group-prepend">
			<span class="input-group-text" id="inputGroupFileAddon01">파일 첨부

                <?php if($i==0) echo"(가입신청서)"; else if($i==1) echo"(발신변경 신청서 01)"; else if($i==2) echo"(발신변경 신청서 02)"; ?>
            </span>
		</div>
