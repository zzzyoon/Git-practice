...
<div id="bo_list">
    ...
    <!-- 대행사 --->
    <form method="post" name="sfrm2" id="sfrm2" action="<?=$_SERVER['PHP_SELF']?>" >
    ...
    <div class="row align-middle">
        ...
        * 대행사 :
        ...
        <div class="col-md-6">
            년도 : &nbsp;
            <select name="wr_2" id="wr_2" class="form-control-sm d-inline w-auto">
                <?php
            ...
            &nbsp;
            <button type="button" id="btnTopSearch" class="btn btn-sm btn-info">조회</button>
        </div>
...
<script>
    ...
    $(function(){
        ...
        $('#sfl_so_no').change(function(){
            ...
            $.get("<?php echo G5_BBS_URL?>/ajax.distributor_select_options.php",
                {'so_no':so_no},
                function(data){
                    $('#sfl_dt_no').html(data);
                });
        ...
        $('#sfl_dt_no').change(function(){
            ...
            $.get("<?php echo G5_BBS_URL?>/ajax.agency_select_options.php",
                {'dt_no':dt_no},
                function(data){
                    $('#sfl_ag_no').html(data);
                });
    ...
    function doSearch(){
        ...
        if(agNo.length > 0 || dtNo.length > 0 || soNo.length > 0){
            sfl += "||wr_1";
        }

        if(agNo.length>0)
            stx+=" "+agNo;
        else if(dtNo.length>0)
            stx+=" "+dtNo;
