...
if($view['wr_2'])
    $view['wr_2_nm'] = getAgencyName($view['wr_2']);


if($view['wr_1']){
    $group = get_member_group($view['wr_1']);
    $view['wr_1_nm'] = $group['mg_name'];
}
?>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <div class="row mt-3">
        <div class="col-md-6 form-group label-floating">
            <label for="wr_1_nm" class="font-weight-bold">학교
                <?php if($view['wr_1']) { ?>
                <a href="#"  id="btn_group_info"><i class="fas fa-info-circle" ></i></a>
                <?php } ?>
            </label>

            <input type="hidden" name="wr_1" id="wr_1" value="<?php echo $view['wr_1'] ?>" >
            <input type="text" name="wr_1_nm" value="<?php echo $view['wr_1_nm'] ?>" id="wr_1_nm" readonly class="form-control readonly font-weight-bold" placeholder="">
        ...
        <div class="col-md-6 form-group label-floating">
            ...
            <input type="hidden" name="wr_2" id="wr_2" value="<?php echo $view['wr_2'] ?>" >
            <input type="text" class="form-control readonly" readonly name="wr_2_nm" id="wr_2_nm" placeholder="" value="<?php echo $view['wr_2_nm'] ?>">
        </div>
    ...
    <div class="row">
        <div class="col-md-2 form-group label-floating">
            ...
            <input type="text" class="form-control readonly font-weight-bold" readonly name="wr_3" id="wr_3" value="<?php echo $view['wr_3'] ?>">
        </div>


        <div class="col-md-2 label-floating">
            <label class="control-label font-weight-bold" for="wr_4">전화번호</label>
            <input type="text" class="form-control readonly font-weight-bold" readonly name="wr_4" id="wr_4" value="<?php echo phoneNumberFormat($view['wr_4']); ?>">
        </div>

        <div class="col-md-2 form-group label-floating">
            <label class="control-label" for="wr_5">아이디 (안심번호)
                <?php if($view['wr_5']) { ?>
                <a href="#"  id="btn_member_info"><i class="fas fa-info-circle" ></i></a>
                <?php } ?>
            </label>
            <input type="text" class="form-control readonly"  readonly  name="wr_5" id="wr_5" value="<?php echo phoneNumberFormat($view['wr_5']); ?>">
        </div>
        ...
        <div class="col-md-3 form-group label-floating">
            ...
            <input type="text" class="form-control readonly"  readonly  name="wr_9" id="wr_9" value="<?php echo phoneNumberFormat($view['wr_9']); ?>">
        </div>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
            ...
            <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" onclick="isDelete(this.href); return false;" class="btn btn-raised btn-warning btn-sm text-light">삭제</a></li><?php } ?>
...
function isDelete(href){

    if(!confirm("한번 삭제한 자료는 복구할 방법이 없습니다.\n\n정말 삭제하시겠습니까?")) {
        return false;
    }

    var actionUrl = href.replace("delete.php","ajax.delete.php");
    ...
    $.get(actionUrl,function(data){
        ...
        if(json.result_stat) {
            socket.emit('delete', {bo_table: '<?=$bo_table?>', wr_id: '<?=$wr_id?>'});
            document.location.href = '/bbs/board.php?bo_table=<?=$bo_table?>';
        }
