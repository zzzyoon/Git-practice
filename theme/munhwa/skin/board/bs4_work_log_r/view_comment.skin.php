...
<section id="bo_vc">
    ...
    <?php } ?>
    <?php if ($i == 0) { //댓글이 없다면 ?><p id="bo_vc_empty">등록된 항목이 없습니다.</p><?php } ?>
...
<aside id="bo_vc_w">
	...
	<div class="form-group label-floating">
		...
		<input type="text" class="form-control" id="wr_name" name="wr_name" value="<?php echo get_cookie("ck_sns_name"); ?>">
	</div>
  ...
  <div class="form-check">
    ...
    <div class="row">
        <div class="col-md-6 form-group label-floating">
            <label class="control-label" >특이사항 입력</label>
	...
	<button type="submit" id="btn_submit" class="btn btn-raised btn-secondary btn-sm">댓글 등록</button>
	</div>
	</div>
    </form>
</aside>
