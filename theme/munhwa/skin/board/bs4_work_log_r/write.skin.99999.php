   ...
   <div class="row">
    ...
    <script>
        ...
        $(function() {
            ...
            //calamasi.showMsg('hello');
            calamansi.addLog("event log testing");
            calamansi.addLog("event log testing2222222");
...
//    document.all['event_log'].value += "SendHangupEvent  = " + evtdata + "\n";
    ...
    calamansi.setLineMsg("전화끊김"); // 전화끊김 > default DISCONNECT
    calamansi.addLog("SendHangupEvent(전화끊어짐)  = " + evtdata);
</script>
