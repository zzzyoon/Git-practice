...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <div class="row my-3 justify-content-end">
        <div class="col-6 col-md-2 text-right border-bottom p-2">
        ...
        <div class="col-6 col-md-2 text-right border-bottom p-2">
            ...
            <?php } else { ?>
                <span class="btn btn-sm btn-secondary rounded px-2"> _ _ _  </span>
            <?php  } ?>
        </div>
        <div class="col-md-3 text-right border-bottom p-2">
            완료 시간
            <?php if($view['wr_8']) { ?>
             <span class="btn btn-sm btn-primary rounded px-2"> <?php echo $view['wr_8']?></span>
            <?php } else { ?>
                <span class="btn btn-sm btn-secondary rounded px-2"> 0000-00-00 00:00:00 </span>
            <?php } ?>
         </div>
    ...
    <section id="bo_v_atc">
        ...
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con" class="border border-secondary rounded p-3">
