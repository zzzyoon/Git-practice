...
<div class="container">
	...
	<div class="row justify-content-md-center">
		...
		<a tabindex="0" role="button" class="btn btn-sm btn-outline-danger rounded-pill text-danger px-4 btn-cb"  data-clipboard-text="<?php echo phoneNumberFormat($member['mb_id'])?>" onclick="alert('안심번호가 클립보드로 복사되었습니다. ');" >
			<h5><span class="d-none d-md-inline">회원님의 </span>안심번호 <?php echo phoneNumberFormat($member['mb_id'])?> <i class='far fa-copy'></i></h5>
		</a>
	...
	<div class="row justify-content-md-center mt-3">
		...
		<div class="list-group my-4">
			...
			<div class="list-group-item list-group-item-action text-center">
				...
				<button type="button" id="btn_call_resume" class="btn btn-primary  <?=($member['mb_call_stat']=="A")?"d-none":""?> " >
					<i class="fas fa-toggle-on"></i><span >  번호 다시 사용하기</span>
				</button>
			...
			<div class="list-group-item list-group-item-action text-center bg-light">
				<small class="text-info">*  번호 "일시중지" 시, <span class="font-weight-bold">"연결서비스가 중지중이어서 전화연결을 할 수가 없습니다"</span>라는 통화대기 안내멘트가 발신자에게 제공됩니다.</small>
			</div>
		</div>
		...
		<div class="list-group my-4">
			<div class="list-group-item list-group-item-info">
				*연결 전화번호 &nbsp; <small>(최종 수정일 : <?php echo wellKnownDatetimeFormat($latestModDate)?>)</small>
			</div>
			<div class="list-group-item list-group-item-action text-center border-bottom-0">
				<input type="text" class="form-control text-primary text-h-4 text-center" id="mb_hp" value="<?php echo phoneNumberFormat($member['mb_hp'])?>">
			</div>

			<div class="list-group-item list-group-item-action text-center">
				<button type="button" id="btn_mod" class="btn btn-secondary btn-block" >전화번호 수정하기</button>
			</div>

			<div class="list-group-item list-group-item-action text-center bg-light">
				<small class="text-info">*  연결 번호 수정시 24시간 이내  재 수정 불가능합니다. </small>
			</div>
		</div>
		</div>
