...
<h3><?php echo $g5['title'] ?></h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <?php echo $cmType?>
                                ...
                                <?php echo $slist[$i]['cm_name']; ?>


                            <a  class="text-secondary pull-right" href="javascript:showAudioModal('<?=$slist[$i]['cm_name']?>','<?=$slist[$i]['cm_filename']?>')"><i class="fas fa-volume-up"></i></a>
                        </div>
    ...
    <!-- 개인 멘트 목록   --------------------------------------------------------------------------------------->
    <form name="mentList" id="mentList" action=""  method="post">
            ...
            for ($i=0; $i<count($list); $i++) {
                ...
                <div class="card">
                    <div class="card-header align-bottom">
                        ...
                        <a href="<?=$list[$i]['view_href']?>" class="font-weight-bold">
                    ...
                    <div class="card-body  p-3">
                        <p class="card-text text-center mt-1">
                            <i class="fas fa-clock"></i> <?php echo $list[$i]['cm_datetime']; ?>
                        </p>
                    </div>
                    <div class="card-footer text-right">
                        <a href="javascript:showAudioModal('<?=$list[$i]['cm_name']?>','<?=$list[$i]['cm_filename']?>')" class="btn btn-sm btn-outline-secondary">* 멘트듣기 <i class="fas fa-volume-up  text-secondary"></i></a>
                    </div>
                </div>
                <?php
            } // end for_________________
