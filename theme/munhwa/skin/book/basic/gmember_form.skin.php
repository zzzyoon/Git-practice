    ...
    <div class="regist-form">
        ...
        <form id="fregisterform" name="fregisterform" action="<?php echo $action_url ?>" onsubmit="return  fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div id="register_form"  class="form_01">
                ...
                <div id="section_siteinfo">
                    <p class="regist-title"><i class="fa fa-edit"></i> 사이트 이용정보 입력  <small class="text-warning">참고)"*" 표시가 들어간 입력항목은 필수 입니다.</small>
                        ...
                        <li class="list-group-item">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="mb_id" value="<?php echo $mem['mb_id'] ?>" id="reg_mb_id"   <?php echo $readonly ?> class="form-control font-weight-bold" minlength="12" maxlength="20" placeholder="*아이디">

                                    </div>
                                    <div class="col-md-6 p-1">
 <?php if($w=="u"){ ?>

                                        <button type="button" id="btn_call_stat" class="btn <?=$callStatClass?>">안심번호 상태 : <?=$callStat?></button>


                                                <button type="button" id="btn_call_hold" class="btn btn-danger <?=($mem['mb_call_stat']=="H")?"d-none":""?> " ><i class="fas fa-toggle-off"></i><span class="d-none d-md-inline"> 번호 일시중지</span></button>

                                                <button type="button" id="btn_call_resume" class="btn btn-primary  <?=($mem['mb_call_stat']=="A")?"d-none":""?> " ><i class="fas fa-toggle-on"></i><span class="d-none d-md-inline">  번호 사용하기</span></button>


                                            <button type="button"  id="btn_call_chk" class="btn btn-secondary  <?=($mem['mb_call_stat']!="A")?"d-none":""?>" ><i class="fas fa-question-circle"></i><span class="d-none d-md-inline"> 번호 체크</span></button>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <?php if($w==""){ ?>
                                            <small id="mbidHelp" class="form-text text-info pl-2">*교직원 아이디는 050으로 시작되는 안심번호를 이용하며, 자동 생성&등록됩니다. </small>
                                        <?php } else { ?>
                                            <small id="mbidHelp" class="form-text text-info pl-2">*교직원 아이디는 050으로 시작되는 안심번호를 이용합니다.  </small>
                                        <?php } ?>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="mb_password" id="reg_mb_password" <?php echo $required ?> class="form-control  bg-gray-0 <?php echo $required ?>" minlength="3" maxlength="20" placeholder="*비밀번호">
                                    </div>
                                </div>
                ...
                <div id="section_pers" class="tbl_frm01 tbl_wrap">
                    <p class="regist-title"><i class="fas fa-user"></i> 개인정보 입력</p>
                    ...
                    <ul class="list-group mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($mem['mb_name']) ?>" <?php echo $required ?> class="form-control frm_input  bg-gray-0 half_input <?php echo $required ?>" size="10" placeholder="*이름" onblur="this.value = this.value.trim()">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="mb_hp" value="<?php echo $mem['mb_hp'] ?>" id="reg_mb_hp" <?php echo ($gconfig['gm_req_hp'])?"required":""; ?> class="form-control font-weight-bold frm_input  bg-gray-0 right_input half_input numeric <?php echo ($gconfig['gm_req_hp'])?"required":""; ?>" onblur="this.value = this.value.replace(/[- ._]/gi,'')"  maxlength="20" placeholder="*휴대폰번호">

                                <small class="text-info mt-1 ml-3 small" role="alert">
                            ...
                            <div class="form-group col-md-6">
                                <div class="form-group">
                                    <label for="reg_mb_2" class="sound_only">대표번호</label>
                                    <input type="text" name="mb_2" value="<?php echo get_text($mem['mb_2']) ?>" id="reg_mb_2" class="form-control frm_input half_input numeric" maxlength="20" placeholder="대표번호">
                                    <small class="text-info mt-1 ml-3 small" role="alert">
                                        * 각반에 있는 일반번호를 입력해주세요.<br> 위에 지정된 번호가  안심통화 및 문자발송시  고객에개 노출되며, 미입력시 학교 대표번호가 이용됩니다.

                                         (* '-' 제외 숫자만 입력, 050 안심번호 및 010 휴대폰번호는 발신번호로 사용불가)
            ...
            <div id="section_worktime">
                <p class="regist-title"><i class="fas fa-cog"></i> 개인 안심번호 설정
                            ...
                            <div class="col-md-6 p-1">
                                ...
                                <div class="card">
                                    <div class="card-header bg-info font-weight-bold text-light">
                                       <i class="fas fa-clock"></i>  업무 시간 정보
                                    </div>
                                    <div class="card-body text-center">
                                        <p class="card-text text-center font-weight-bold">
                                            <?php if($view['wt_start_time'] && $view['wt_end_time']) { ?>
                                                <?=$view['wt_start_time']?> ~ <?=$view['wt_end_time']?> /  <?=$view['work_days']?>
                                            <?php } else { ?>
                                                미설정
                                            <?php } ?>

                                            <?php if($view['wt_lunch_time']) {?>
                                                    <small class="bg-secondary text-light rounded-pill p-2 my-1 d-inline-block">점심시간 : <?=$view['wt_lunch_time']?></small>
                                            <?php }?>
                                        </p>
                                    </div>
                                    <div class="card-footer text-center">
                                        -발신 멘트 : <?=$view['wt_fwd_ment_name']?> <br>
                                        -착신 멘트 : <?=$view['wt_rcv_ment_name']?> <br>
                                        -업무종료 멘트 : <?=$view['wt_end_ment_name']?>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 p-1">
                                ...
                                <div class="card">
                                    <div class="card-header bg-success font-weight-bold text-light">
                                        <i class="fas fa-mug-hot"></i> 휴식 시간 정보
                                    </div>
                                    <div class="card-body">
                                        <p class="card-text text-center">
                                            <?php
                                            for ($i=0; $i<count($rlist); $i++) {
                                                echo $rlist[$i]['num'].". ".$rlist[$i]['rm_name']."  ".$rlist[$i]['rm_time']." (*".$rlist[$i]['rm_day_names'].")<br>";
                                            }
                                            if(count($rlist)==0){
                                                echo"미설정";
                                            }
            ...
            <div class="btn_confirm btn_box">
                ...
                <?php if(!$mem["mb_leave_date"]){ ?>
                    <input type="submit"   value="<?php echo $w==''?'추가하기':'수정하기'; ?>" id="btn_submit" class="btn btn-primary" accesskey="s">
                <?php } ?>
...
//        });
        ...
        $('#btn_call_reg').click(function(){
            ...
            requestAutoRegSafetyNumber(true); // 안심번호 자동할당 & 등록
        });
    ...
    */
    ...
    function validateSafeNumber(safetyNumber){
        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                result = Boolean(data.result_stat);
    ...
    function requestCheckSafetyNumberAlert(){
        ...
        if(res1.Shop_phone == "0") //미사용
            ...
            alert('* 오류발생 \n\n 현재 안심번호 ' + phone_format(safetyNumber) + '  ▶  ' + phone_format(res1.Shop_phone) + ' 연결 중,  \n   ~상태는 : [ ' + statusName + ' ] 입니다. \n\n 관리자에게 문의 바랍니다.');
        }
    ...
    function requestCheckSafetyNumber(){
        ...
        var safetyNumber = $("#reg_mb_id").val().trim().replace(/[- ]/gi, "");
        var safetyName = $('#reg_mb_name').val().trim().replace(/[- \.\?,_~&^%\$\!@+#\(\)<>\{\}\[\]\\`]/gi, "");
    ...
    /// 안심번호 등록 API 요청 함수_________________________ -.- ___________
    /*
    function requestRegSafetyNumber(isAlert){ //params = boolean
        ...
        // 멘트 활성화 API ______________________________
        var res9 = tlog_number_member(safetyNumber);

        // 안심번호 등록 정보 > 로컬 DB 업데이트
    ...
    }  //end  requestRegSafetyNumber method ========================================
*/



    /// 안심번호 자동등록 API 요청 함수_________________________ -.- ___________
    function requestAutoRegSafetyNumber(isAlert){ //params = boolean

        //var safetyNumber = $("#reg_mb_id").val().trim().replace(/[- ]/gi, "");
        var safetyName = $('#reg_mb_name').val().trim().replace(/[- \.\?,_~&^%\$\!@+#\(\)<>\{\}\[\]\\`]/gi, "");
        var targetNumber = $('#reg_mb_hp').val().trim().replace(/[- \.]/gi, "");

        if(!safetyName || !targetNumber)
            return false;
        ...
        // 안심번호 자동등록 API 호출
        var res1 = tlog_number_auto_assign(safetyName, targetNumber);

        if (!res1 || res1.Result != "1") {
            //  alert("안심번호 등록에 실패했습니다. (1 / ErrorCode : "+res1.ErrCode+")");

            if(res1 && res1.hasOwnProperty("ErrCode")) {
                alert("안심번호 자동등록에 실패했습니다. (1 / 원인 :  "+tlog_get_error_msg(res.ErrCode)+" ) ");
            } else {
                alert("안심번호 자동등록에 실패했습니다. (1)");
            }

            return false;
        } else {
            if(res1.hasOwnProperty("DNIS")){
                $('#reg_mb_id').val(res1.DNIS);
            } else {
                alert('자동 생성된 회원 안심번호를 할당받는데 실패했습니다.');
                return false;
            }
        }
    ...
    function requestResumeSafetyNumber(){
        ...
        var cf = confirm('해당번호를 다시 정상 사용하시겠습니까?');
        if(!cf)
            return false;
        ...
        updateCallStat(safetyNumber,'A', function(stat,msg) {
            ...
            if(stat){
                $('#btn_call_stat').removeClass('btn-outline-secondary').addClass('btn-outline-primary font-weight-bold').text('안심번호 상태 : 사용중');
    ...
    function requestHoldSafetyNumber(){
        ...
        updateCallStat(safetyNumber,'H', function(stat,msg) {
                ...
                if(stat){
                    $('#btn_call_stat').removeClass('btn-outline-primary font-weight-bold').addClass('btn-outline-secondary').text('안심번호 상태 : 정지');
                    $('#btn_call_hold').hide();
    ...
    //추가 가능한 회원수 체크 ================================================
    function validateGmemberCount(){

        var result=false;
        var actionUrl = "<?php echo G5_BBS_URL?>/ajax.gmember_count_validate.php"
    ...
    function fregisterform_submit(f) {
        ...
        //문자 회신번호 (대표번호) 체크 _______________________________________
        // var spcPattern = /[- \._]/gi;
        ...
        if(cbNumber.length > 0 && virPattern.test(cbNumber)){
            alert('안심번호(050)는 대표번호로 사용할 수 없습니다.');
            $('#reg_mb_2').val('').focus();
            isSubmit = false;
            $('#btn_submit').show();
            return false;
        ...
        if(cbNumber.length > 0 && moPattern.test(cbNumber)){
            alert('개인 휴대폰 번호는 대표번호로 사용할 수 없습니다.');
            $('#reg_mb_2').val('').focus();
            isSubmit = false;
            $('#btn_submit').show();
            return false;
        ...
        */
        ...
        // 회원 카운팅 체크 (* 자동 발급으로 인한 회원수 제한)
        var cntCheck = validateGmemberCount();
//        console.log(cntCheck);
        ...
        if (f.w.value == "") {
            ...
            alert(' * 안심번호 등록 처리 중입니다. \n\n   아래 확인 버튼을 누른 후,  [ 완료 메세지 ] 가 나타날때까지 잠시만 기다려 주세요~ \n ');
            ...
            /*
                ...
                if(!chkSvr){
                    ...
                    res = requestAutoRegSafetyNumber(false);  // 자동번호 할당 &  return fase & alert포함__
        ...
        return true; //submit request____________________________
    }
