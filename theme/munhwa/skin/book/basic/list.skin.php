...
<!--            --><?php //if ($write_href) { ?><!--<li><a href="--><?php //echo $write_href ?><!--" class="btn btn-raised btn-primary btn-sm">문의등록</a></li>--><?php //} ?>
    ...
    <input type="hidden" name="page" value="<?php echo $page; ?>">
        ...
        <tr>
            ...
            <th scope="col" class="d-none d-sm-none d-md-table-cell">직책</th>
            <th scope="col" >아이디</th>
            <th scope="col" class="d-none d-sm-none d-md-table-cell" >이름</th>
            <th scope="col" class="d-none d-sm-none d-md-table-cell">휴대폰번호</th>
        ...
        <tr>
            ...
            <td class="qa_link">
                ...
                <div class="text-info d-block d-sm-none pl-1" ><small>직책 :  <?php if($list[$i]['mb_9']) echo $list[$i]['mb_9']; else echo"미설정"; ?></small></div>
                <div class="text-info d-block d-sm-none pl-1" ><small>이름 : <?php echo $list[$i]['mb_name'] ?></small></div>
            </td>
            <td class="cen d-none d-sm-none d-md-table-cell"><?php echo $list[$i]['mb_name']; ?></td>
            <td class="cen d-none d-sm-none d-md-table-cell"><?php echo phoneNumberFormat($list[$i]['mb_hp']); ?></td>
            <td class="cen d-none d-sm-none d-md-table-cell"><?php echo $list[$i]['mb_leave_date']; ?></td>
            <td class="cen"><?php echo $list[$i]['mb_datetime']; ?></td>
        </tr>
        <?php
        }
        ?>
    ...
    <div class="bo_fx">
        <ul class="btn_bo_user">
            ...
            <?php if($excel_href) { ?><li><a href="<?php echo $excel_href ?>" class="btn btn-raised btn-danger btn-sm">엑셀 다운로드</a></li><?php } ?>
            <?php if ($list_href) { ?><li><a href="<?php echo $list_href ?>" class="btn btn-raised btn-secondary btn-sm">목록</a></li><?php } ?>
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn btn-raised btn-primary btn-sm">회원 등록</a></li><?php } ?>
        </ul>
    </div>
