...
<!--            </li>-->
        ...
        <div class='d-flex justify-content-center'>
            ...
            &nbsp;
            <button type="submit" class="btn btn-lg btn-primary" ><?=(empty($rm_no))?"저장하기":"수정하기";?></button>
        </div>
...
<script>
    ...
    function deleteTime(){
        ...
        var cf = confirm('해당 휴식시간 설정을 삭제하시겠습니까? ');
        if(!cf)
            return false;
        ...
        var actionUrl = "<?php echo G5_BBS_URL?>/ajax.gmember_resttime_delete.php"
        $.ajax({
            method: "POST",
            dataType:"json",
            url:actionUrl,
            ...
            success:function(data) {
                ...
                if(result){
                    ...
                    location.href='./gmember_resttime_list.php';
                } else {
                    alert('*삭제 실패 : \n'+data.result_msg);
                }
                ...
                alert("휴식시간 삭제시 오류가 발생했습니다. ("+error+")");
            }
        }); //end ajax func ====
    ...
    function formSubmit(){
        ...
        var actionUrl = "<?php echo G5_BBS_URL?>/ajax.gmember_resttime_update.php"
        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                alert("휴식시간 설정시 오류가 발생했습니다. ("+error+")");
            }
        }); //end ajax func ====
