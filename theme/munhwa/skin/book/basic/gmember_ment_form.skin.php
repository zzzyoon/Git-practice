...
<form id="mentFrm" name="mentFrm" method="post" onsubmit="return formSubmit()" action="" autocomplete="off">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <small class="text-info">
                        * 참고1 <br>
                        <strong>통화대기 안내멘트</strong> : 전화를 거는 발신자에게 통화 대기 중 안내되는 멘트입니다.<br>
                        <strong>통화연결 안내멘트 </strong> : 전화를 받는 즉, 교사들에게 통화 연결 전 안내되는 멘트입니다.
                    </small>
                    -->
                </div>
                <div class="col-md-6">
                    ...
                    <small class="text-info">
                        * 참고2 <br>
                        멘트 내용으로 입력한것이 음성 데이터로 생성되며, 영문사용시 부정확하게 멘트가 생성될 수 있습니다. 한글 및 숫자 조합으로 내용을 입력해주시길 바랍니다.
                        <br>
                        생성된 멘트는 <strong>"안심번호 설정 > 업무시간, 추가시간 설정"</strong>  등에서 이용할 수  있습니다.
                    </small>
                    -->
                </div>
    ...
    <div class='d-flex justify-content-center'>
        ...
        <a href="<?=$list_href?>" class="btn btn-lg btn-secondary text-light">목록</a>
        <?php if($cm_no) { ?>

            &nbsp;
            <button type="button" id="btnDelete" class="btn btn-lg btn-danger" >삭제</button>
...
var IS_REQUEST=false;
    ...
    function deleteMent(){
        ...
        var actionUrl = "<?php echo G5_BBS_URL?>/ajax.gmember_ment_delete.php"
        $.ajax({
            method: "POST",
            dataType:"json",
            url:actionUrl,
            ...
            success:function(data) {
                ...
                if(result){
                    ...
                    location.href='./gmember_ment_list.php';
                } else {
                    alert('*삭제 실패 : \n'+data.result_msg);
                }
    ...
    function formSubmit(){
        ...
        var actionUrl = "<?php echo G5_BBS_URL?>/ajax.gmember_ment_update.php"
