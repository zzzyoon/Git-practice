    ...
    <input type="hidden" name="page" value="<?php echo $page; ?>">
        ...
        <div class="card-columns">
            ...
            for ($i=0; $i<count($list); $i++) {
                ...
                // 상태
                if($list[$i]['rm_stat'] == "Y")
                    $restStat = "<button type='button' class='btn btn-sm btn-warning' >On</button>";
                else
                    $restStat = "<button type='button' class='btn btn-sm btn-secondary' >Off</button>";
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <?=$restStat?>
                        <strong>
                        <a href='./gmember_resttime_form.php?rm_no=<?=$list[$i]['rm_no']?>' class="btn btn-sm btn-outline-primary text-primary" ><?php echo $list[$i]['rm_name']?></a>
                        </strong>
                        &nbsp;
