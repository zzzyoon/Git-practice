            ...
            <div id="register_form"  class="form_01">
                ...
                <div class="tbl_frm01 tbl_wrap">
                    ...
                    <ul class="list-group mb-4">
                        ...
                        <li class="list-group-item">
                            <div class="form-group">
                                <label for="reg_mb_2" class="sound_only">문자 발신번호</label>
                                <input type="number" name="mb_2" value="<?php echo get_text($mem['mb_2']) ?>" id="reg_mb_2" class="form-control frm_input half_input" maxlength="20" placeholder="문자 발신번호">
                                <div class="text-danger mt-1 ml-3 small" role="alert">
                                    * 참고 : 각 반에 있는 일반 전화번호를 입력해주세요. &nbsp; 미입력시 <span class="alert-link">학교 대표 발신번호</span>로 문자 발송처리되므로, 교무실로 전화가 집중 될 수 있습니다.
                        ...
                        <li class="list-group-item">
                            <div class="form-group">
                                ...
                                <div class="text-danger mt-1 ml-3 small" role="alert">
                                    * 참고 :  050 안심번호는 해당 휴대폰번호로 착신처리됩니다. ('-' 제외 숫자만 입력)
                                </div>
...
<script>
    ...
    function fregisterform_submit(f) {
        ...
        // 회신번호 체크 _______________________________________
        var spcPattern = /[- \._]/gi;
