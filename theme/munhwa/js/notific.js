...
//CSSLoad('notific.css'); //bylee .  //Loading CSS. Загрузка CSS
  ...
  close:function(element,timeOut) { //bylee / ie11 error > timeOut=400 제거
  ...
  options:function(options,params){ //bylee > ie11 error > params=this.settings 제거
...
const ToastBox = {
  showToast:function(msg){
    ...
    if(window.hasOwnProperty("Android")){
      window.Android.showInfoToast(msg);
    } else {
      return Message.add(msg, {
        type: 'warning',             // default,info,success,warning,error
        vertical: 'center',
        horizontal: 'center',
        close: false,
        insert: 'prepend'
  ...
  showSuccessToast:function(msg){
    ...
    if(window.hasOwnProperty("Android")){
      window.Android.showSuccessToast(msg);
    } else {
      return Message.add(msg, {
  ...
  showWarningToast:function(msg){
    ...
    if(window.hasOwnProperty("Android")){
      window.Android.showWarningToast(msg);
    } else {
      return Message.add(msg, {
        type: 'warning',             // default,info,success,warning,error
        vertical: 'center',
  ...
  showErrorToast:function(msg){
    ...
    if(window.hasOwnProperty("Android")){
      window.Android.showErrorToast(msg);
    } else {
      return Message.add(msg, {
  ...
  showLongToast:function(msg){
    if(window.hasOwnProperty("Android")){
      window.Android.showLongToast(msg);
    } else {
      return Message.add(msg, {
        type: 'warning',
        vertical: 'center',
  ...
  showLoadingToast:function(msg){
    //return  Message.add(msg, {type: 'loader',return:'object',vertical:'center',horizontal:'center', insert: 'prepend'});
    _toastLoadingBox = Message.add(msg, {type: 'loader',return:'object',vertical:'center',horizontal:'center', insert: 'prepend'});
    return _toastLoadingBox;
  },
  closeToast:function(){
    try {
      if (_toastLoadingBox.length <= 0)
        return;
      Message.close(_toastLoadingBox, 200);
    }catch(e){
