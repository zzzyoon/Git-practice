...
//define('G5_ORACLE_HOST', '210.114.175.31'); //easy dev server
//define('G5_ORACLE_HOST', '211.108.61.71'); // real server
define('G5_ORACLE_HOST', '211.58.254.245'); // 임시
define('G5_ORACLE_PORT', '1521');
define('G5_ORACLE_USER', 'capo');
define('G5_ORACLE_PASSWORD', 'capo');
define('G5_ORACLE_SID', 'orcl');
define('G5_ORACLE_CHARSET', 'KO16MSWIN949');



define('G5_TABLE_PREFIX', 'g5_');

$g5['member_table'] = 'ctpass'; // 회원 테이블  . bylee 수정
